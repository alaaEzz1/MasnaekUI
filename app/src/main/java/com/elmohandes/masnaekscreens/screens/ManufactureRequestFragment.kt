...
import com.elmohandes.masnaekscreens.databinding.FragmentManufactureRequestBinding
import com.elmohandes.masnaekscreens.models.MainCategoryModel


class ManufactureRequestFragment : Fragment() {

    lateinit var categoryList:List<MainCategoryModel>
    lateinit var spinnerAdapter: SpinnerAdapter
    lateinit var binding: FragmentManufactureRequestBinding
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_manufacture_request, container, false)
        binding = FragmentManufactureRequestBinding.bind(view)
        ...
        binding.manufactureReqSpinner.adapter = spinnerAdapter
